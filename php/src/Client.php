...
namespace APIVerve\Imageconverter;
...
/**
 * Client for the Image Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/imageconverter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/imageconverter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ImageconverterClient] {$message}\n";
        }
    }
}
