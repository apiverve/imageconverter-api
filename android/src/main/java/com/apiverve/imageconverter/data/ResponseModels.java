...
//
//     ImageConverterData data = Converter.fromJsonString(jsonString);

package com.apiverve.imageconverter.data;
...
public class Converter {
    ...
    public static ImageConverterData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(ImageConverterData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(ImageConverterData.class);
        writer = mapper.writerFor(ImageConverterData.class);
    }
...
public class ImageConverterData {
    private UUID id;
