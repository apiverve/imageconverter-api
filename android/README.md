...
```gradle
dependencies {
    implementation 'com.github.apiverve:imageconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.imageconverter.ImageConverterAPIClient;
import com.apiverve.imageconverter.APIResponse;
import com.apiverve.imageconverter.APIException;

// Initialize the client
ImageConverterAPIClient client = new ImageConverterAPIClient("YOUR_API_KEY");
...
This API requires a file upload. Supported file types: .heic, .heif, .avif, .webp, .png, .jpg, .jpeg, .gif, .tiff, .tif, .bmp, .pdf, .svg (max 10MB)
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/imageconverter](https://docs.apiverve.com/ref/imageconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/imageconverter](https://docs.apiverve.com/ref/imageconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/imageconverter-api/issues)
