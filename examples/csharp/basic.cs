/*
 * Image Converter API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Image Converter API.
 * API Documentation: https://docs.apiverve.com/ref/imageconverter
 */
...
namespace APIVerve.Examples
{
    class ImageConverterExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/imageconverter";

        /// <summary>
        /// Make a GET request to the Image Converter API
        /// </summary>
        static async Task<JsonDocument> CallImageConverterAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Image Converter API...\n");

            var result = await CallImageConverterAPI();
